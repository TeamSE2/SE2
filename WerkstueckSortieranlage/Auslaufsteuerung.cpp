...
void Auslaufsteuerung::transitionenAusfuehren(){
	...
	if(plaetze[GZ] && !plaetze[CHECK_1] && eingang[LICHTSCHRANKE_W]){
		plaetze[GZ] = 0;
		plaetze[CHECK_1] = 1;
		ladeWerkstueck();
	...
	if(plaetze[CHECK_1] && !plaetze[WENDEN_1] && !eingang[LOCH] && !eingang[LICHTSCHRANKE_A]){
		plaetze[CHECK_1] = 0;
		plaetze[WENDEN_1] = 1;
	...
	if(plaetze[CHECK_2] && !plaetze[WENDEN_1] && eingang[METALL_A] && !eingang[LICHTSCHRANKE_A]){
		plaetze[CHECK_2] = 0;
		plaetze[WENDEN_1] = 1;
